package com.deloitte.agendador_horarios.controller;

import com.deloitte.agendador_horarios.infrastructure.entity.Agendamento;
import com.deloitte.agendador_horarios.services.AgendamentoService;
...
public class AgendamentoController {
    ...
    @DeleteMapping
    public ResponseEntity<Void> deletarAgendamento(@RequestParam String aluno,
                                                   @RequestParam LocalDateTime dataHoraAgendamento) {

        agendamentoService.deletarAgendamento(dataHoraAgendamento, aluno);
    ...
    public ResponseEntity<Agendamento> alterarAgendamentos(@RequestBody Agendamento agendamento,
                                                           ...
                                                           @RequestParam LocalDateTime dataHoraAgendamento) {
        return ResponseEntity.accepted().body(agendamentoService.alterarAgendamento(agendamento, aluno, dataHoraAgendamento));
    }
}